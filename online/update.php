...
</script></head><body><div id="container"></div><div id="Layer10"><div id="Layer10_Container"><div id="wb_Image5"><img src="images/placeholder.gif" data-src="images/img0011.jpg" id="Image5" alt=""></div><hr id="Line4"><div id="wb_Text13"><span style="color:#FFFFFF;font-family:Arial;font-size:13px;"> 2016 Copyright Smart iPrint. All Rights Reserved.</span></div></div></div><div id="Layer1"><div id="Layer1_Container"><div id="Layer3"><div id="wb_Image1"><a href="./../offline/index.php"><img src="images/placeholder.gif" data-src="images/iprintlogo.jpg" id="Image1" alt=""></a></div></div><form name="Layer2" method="POST" action="<?php echo $editFormAction; ?>" enctype="text/plain" accept-charset="UTF-8" id="Layer2" onsubmit="return ValidateLayer2(this)"><div id="Layer2_Container"><div id="wb_Text1"><span style="color:#808080;font-family:Arial;font-size:35px;"> Update</span></div><input type="text" id="Username" name="Username" value="<?php echo $row_Recordset1['username']; ?>" maxlength="35" readonly><input type="text" id="Firstname" name="Firstname" value="<?php echo $row_Recordset1['firstname']; ?>"><input type="text" id="Lastname" name="Lastname" value="<?php echo $row_Recordset1['lastname']; ?>"><input type="text" id="Addresss" name="Address" value="<?php echo $row_Recordset1['Address']; ?>"><input type="email" id="Email" name="Email" value="<?php echo $row_Recordset1['email']; ?>"><div id="wb_Text4"><span style="color:#696969;font-family:Arial;font-size:24px;">Username:</span></div><div id="wb_Text2"><span style="color:#696969;font-family:Arial;font-size:24px;">Password:</span></div><div id="wb_Text5"><span style="color:#696969;font-family:Arial;font-size:24px;">Firstname:</span></div><div id="wb_Text6"><span style="color:#696969;font-family:Arial;font-size:24px;">Lastname:</span></div><input type="password" id="Password" name="Password" value="<?php echo $row_Recordset1['password']; ?>" maxlength="35"><div id="wb_Text7"><span style="color:#696969;font-family:Arial;font-size:24px;">Address:</span></div><div id="wb_Text3"><span style="color:#696969;font-family:Arial;font-size:24px;">Email:</span></div><input type="submit" id="Button1" name="" value="Submit"></div>
